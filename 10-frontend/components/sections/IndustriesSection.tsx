...
const industries = [
  {
    ...
    icon: "🏭",
    standards: ["ISO 17025"],
    benefit: "Cero no conformidades por calibración",
    description:
      "Calibramos instrumentos críticos de línea con tiempos de respuesta express y certificados con acreditación ISO 17025, listos para tus auditorías de calidad y análisis de sistemas de medición.",
    wins: [
      "Cero interrupciones en ciclo de manufactura",
      "Certificados aceptados en tus procesos de aprobación de partes",
      "Reportes de incertidumbre para análisis de sistemas de medición",
  ...
  },
  {
    ...
    description:
      "Registros de calibración auditables con cadena de custodia completa para tus auditorías regulatorias e internacionales. Trazabilidad completa al SI vía CENAM.",
    wins: [
      "Documentación lista para tus auditorías regulatorias",
  ...
  },
  {
    ...
    description:
      "Calibramos todos los instrumentos críticos de planta con certificados con acreditación ISO 17025. Control certificado de temperatura y proceso.",
    wins: [
      "Válido para tus auditorías de inocuidad alimentaria",
      "Control certificado de temperatura y peso en planta",
      "Historial de calibración para tus programas de control de proceso",
